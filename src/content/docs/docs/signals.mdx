...
- **IoT control loops**: `fromInterval` for any periodic source ([`para:i2c`](https://parabun.script.dev/docs/i2c/) sensors, HTTP polls), `pollHz` on [`para:gpio`](https://parabun.script.dev/docs/gpio/) lines for hardware-backed value signals.
