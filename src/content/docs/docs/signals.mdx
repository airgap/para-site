...
- **IoT control loops**: `fromInterval` for any periodic source ([`parabun:i2c`](https://parabun.script.dev/docs/i2c/) sensors, HTTP polls), `pollHz` on [`parabun:gpio`](https://parabun.script.dev/docs/gpio/) lines for hardware-backed value signals.
